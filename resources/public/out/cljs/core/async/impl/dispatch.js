...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_28086 = (0);while(true){
var m_28087 = cljs.core.async.impl.dispatch.tasks.pop();if((m_28087 == null))
{} else
{m_28087.call(null);
if((count_28086 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__28088 = (count_28086 + (1));
count_28086 = G__28088;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__11369__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__11369__auto__)
