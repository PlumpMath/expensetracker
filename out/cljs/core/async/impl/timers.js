...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_14718 = (0);while(true){
if((i_14718 < arr.length))
{(arr[i_14718] = null);
{
...
{var i_14725 = (self__.level + (1));while(true){
if((i_14725 <= (new_level + (1))))
{(update[i_14725] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_14727 = (0);while(true){
if((i_14727 <= self__.level))
{var links_14728 = (update[i_14727]).forward;if(((links_14728[i_14727]) === x__$1))
{(links_14728[i_14727] = (x__$1.forward[i_14727]));
{
var G__14729 = (i_14727 + (1));
i_14727 = G__14729;
continue;
}
} else
{{
var G__14730 = (i_14727 + (1));
i_14727 = G__14730;
continue;
}
}
