...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_14811 = (0);while(true){
var m_14812 = cljs.core.async.impl.dispatch.tasks.pop();if((m_14812 == null))
{} else
{m_14812.call(null);
if((count_14811 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__14813 = (count_14811 + (1));
count_14811 = G__14813;
continue;
}
} else
{}
